...
public class GetDetailsListBookByTitle 

{
	
		public  final String SOAP_ACTION = "http://tempuri.org/GetDetailsListBookByTitle";
	    public  final String NAMESPACE = "http://tempuri.org/";
	    public  final String METHOD_NAME = "GetDetailsListBookByTitle";
	    public  final String URL = "http://mohamedamir-001-site1.smarterasp.net/service1.asmx";
	    
	   
	    public GetDetailsListBookByTitle(){}

		
		public String GetDetailsListBookByTitles(String Title)
		{
