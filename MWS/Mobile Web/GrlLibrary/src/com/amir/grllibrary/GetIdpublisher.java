...
public class GetIdpublisher 

{
	public  final String SOAP_ACTION = "http://tempuri.org/GetIdpublisher";
    public  final String NAMESPACE = "http://tempuri.org/";
    public  final String METHOD_NAME = "GetIdpublisher";
    public  final String URL = "http://mohamedamir-001-site1.smarterasp.net/service1.asmx";
    
   
    public GetIdpublisher(){}

	
	public String GetIdpublishers(String Name)
	{
