...
public class login 
{
	public  final String SOAP_ACTION = "http://tempuri.org/verifylogin";
    public  final String NAMESPACE = "http://tempuri.org/";
    public  final String METHOD_NAME = "verifylogin";
	...
	public String getlogin(String Usename , String password)
	{
		SoapObject request = new SoapObject(NAMESPACE, METHOD_NAME);
		
		PropertyInfo prinfo = new PropertyInfo();
		prinfo = new PropertyInfo();
		prinfo.setName("Usename");
		prinfo.setValue(Usename);
