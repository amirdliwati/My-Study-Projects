...
<%@ Register src="ctlBoughtTogether.ascx" tagname="ctlBoughtTogether" tagprefix="uc3" %>

<%@ Register src="ctlBoughtAlso.ascx" tagname="ctlBoughtAlso" tagprefix="uc4" %>
...
<asp:FormView ID="FormView1" runat="server" DataKeyNames="BookID" style="width:100%"  
    ...
    <ItemTemplate>
        ...
        <div>
            ...
            <uc3:ctlBoughtTogether ID="ctlBoughtTogether1" runat="server" />
            </td><td width="50%">
            <uc4:ctlBoughtAlso ID="ctlBoughtAlso1" runat="server" />
            </td></tr></table>
        </div>
    </ItemTemplate>
</asp:FormView>
