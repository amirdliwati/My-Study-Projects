<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ctlBoughtAlso.ascx.cs" Inherits="Controls_ctlBoughtAlso" %>
<fieldset><legend>Customers Who Bought This Item Also Bought</legend>
