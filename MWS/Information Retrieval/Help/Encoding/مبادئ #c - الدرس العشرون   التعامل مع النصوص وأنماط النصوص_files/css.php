...
.texteditor textarea {
	color: #222222;
	font:    13px 'Noto Naskh Arabic', serif;
...
.texteditor.forum textarea {
	color: #222222;
	font:    19px 'Noto Naskh Arabic', serif;
	white-space:pre-wrap;
	background: #FFFFFF none   ;
}
...
.popupbody {
	font:   normal 14px 'Noto Naskh Arabic', serif;
	color: #3E3E3E;
	padding:3px;
	background:#ffffff none   ;
	border: 0 none ;
...
.popupbody li.formsubmit input[type="button"] {
	font:14px 'Noto Naskh Arabic', serif;
	padding:2px;
	padding-bottom:1px;
}
...
.button {
	padding: 3px 6px;
	font:   normal 12px 'Noto Naskh Arabic', serif;
...
.navbar {
	...
	font:  normal 15px 'Noto Kufi Arabic', serif;
...
.navtabs li a.navtab {
	...
	text-align:left;
	color: #ffffff;
	font:  normal 16px 'Noto Kufi Arabic', serif;
	text-decoration:none;
...
#pagetitle h1 {
	color: inherit;
	font:normal normal bolder 24px 'Noto Kufi Arabic', serif;
	letter-spacing: -1px;
}
...
.newcontent_textcontrol {
	...
	font:   normal 13px 'Noto Naskh Arabic', serif;
	color: rgb(255, 255, 255);
...
.footer_morecopyright {
	...
	font:  normal 11px 'Noto Naskh Arabic', serif;
	margin-top: 12px;
	text-align:center;
	display:block;
}
...
.textbox, textarea, select {
	font:  normal 16px 'Noto Naskh Arabic', serif;
	color:#000000;
	background:rgb(255, 255, 255) none   ;
	border:1px solid #e4e4e4;
	padding:4px;
