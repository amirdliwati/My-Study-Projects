...
namespace AIRLibrary
{
    public class Index
    {
        ...
        public bool DeleteIndexesEnglish()
        {
            bool status = false;
            SqlConnection con = new SqlConnection(connectionString1);
            SqlCommand cmd = new SqlCommand("DeleteIndexesEnglish", con);
        ...
        public bool DeleteIndexesArabic()
        {
            bool status = false;
            SqlConnection con = new SqlConnection(connectionString1);
            SqlCommand cmd = new SqlCommand("DeleteIndexesArabic", con);
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public bool EnglishIndexes()
        {
            ...
            try
            {
                ...
                for (int i = 1; i <= imageFiles.Length; i++)
                {
                    ...
                    //string MyTerms = getword.GetWords(@"D:\AIR\Assignment\AIRWeb\AIRWeb\Data\" + Convert.ToString(i) + ".doc");
                    string MyTerms = getword.GetWords(path + imageFiles[i-1].ToString());
        ...
        private void AddTermsFreqEnglish(ArrayList arrlst)
        {
            ...
            if (arrlst.Count != 0)
            {
                ...
                SqlConnection con = new SqlConnection(connectionString1);
                SqlCommand cmd = new SqlCommand("AddDictionaryEnglish", con);
                cmd.CommandType = CommandType.StoredProcedure;
                ...
                SqlCommand cmd1 = new SqlCommand("AddPostingEnglish", con);
        ...
        private void AddTermsFreqArabic(ArrayList arrlst)
        {
            ...
            if (arrlst.Count != 0)
            {
                ...
                SqlConnection con = new SqlConnection(connectionString1);
                SqlCommand cmd = new SqlCommand("AddDictionaryArabic", con);
                cmd.CommandType = CommandType.StoredProcedure;
                ...
                SqlCommand cmd1 = new SqlCommand("AddPostingArabic", con);
                cmd1.CommandType = CommandType.StoredProcedure;
